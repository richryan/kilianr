...
Kilian and Lütkepohl discuss this approach in chapter 9 of @kilian_lutkepohl_2017.
...
Inference requires estimating uncertainty.

The package includes several methods for constructing confidence intervals.

Methods for constructing confidence intervals are demonstrated using
a recursively identified monthly structural VAR model of the
global market for crude oil [@kilian_2009].
The example is discussed by @kilian_lutkepohl_2017 in chapter 12.
...
- percent change in world crude-oil production
- an index of real economic activity, and
- the log of the real price of oil.

Here are what the data look like,
excluding the presample:
...
The following code block computes confidence intervals
using a standard boostrap.
```{r}
nrep <- 2000
