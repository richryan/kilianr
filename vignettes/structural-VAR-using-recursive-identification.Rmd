...
dat_irf_global_oil_cs <- bootstrap_standard(olsobj = sol_global_oil, 
                                            ...
                                            nrep = nrep, 
                                            h = horizon, 
                                            bootstrap_seed = 676, print_nrep = FALSE)
```
...
plt_oilsupply_oilsupply <- ggplot(data = dat_irf_global_oil) +
  geom_hline(yintercept = 0.0) +
  geom_line(mapping = aes(x = horizon, y = response_shock_oilsupply_oilsupply)) + 
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_oilsupply_oilsupply_lo)) +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_oilsupply_oilsupply_hi)) +
...
plt_aggdemand_oilsupply <- ggplot(data = dat_irf_global_oil) +
  ...
  # geom_line(data = dat_CI, mapping = aes(x = horizon, y = response_shock_aggdemand_oilsupply_lo)) + 
  # geom_line(data = dat_CI, mapping = aes(x = horizon, y = response_shock_aggdemand_oilsupply_hi)) +     
