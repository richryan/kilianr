...
dat_global_oil_plt <- kilianLutkepohlCh12Figure12_5 |> 
  ...
  filter(date > min(date) + lubridate::months(p - 1))
...
The code base makes computation of the confidence sets strightforward.
```{r}
nrep <- 2000
...
plt_oilsupply_oilsupply <- ggplot(data = dat_irf_global_oil) +
  geom_hline(yintercept = 0.0) +
  geom_line(mapping = aes(x = horizon, y = response_shock_oilsupply_oilsupply)) + 
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_oilsupply_oilsupply_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_oilsupply_oilsupply_hi), linetype = "dotted") +
...
plt_aggdemand_oilsupply <- ggplot(data = dat_irf_global_oil) +
  ...
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_aggdemand_oilsupply_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_aggdemand_oilsupply_hi), linetype = "dotted") +
...
plt_rpoil_oilsupply <- ggplot(data = dat_irf_global_oil) +
  ...
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_rpoil_oilsupply_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_rpoil_oilsupply_hi), linetype = "dotted") +  
...
plt_oilsupply_aggdemand <- ggplot(data = dat_irf_global_oil) +
  geom_hline(yintercept = 0.0) +
  geom_line(mapping = aes(x = horizon, y = response_shock_oilsupply_aggdemand)) +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_oilsupply_aggdemand_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_oilsupply_aggdemand_hi), linetype = "dotted") +    
...
plt_aggdemand_aggdemand <- ggplot(data = dat_irf_global_oil) +
  ...
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_aggdemand_aggdemand_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_aggdemand_aggdemand_hi), linetype = "dotted") +      
...
plt_rpoil_aggdemand <- ggplot(data = dat_irf_global_oil) +
  ...
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_rpoil_aggdemand_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_rpoil_aggdemand_hi), linetype = "dotted") +        
...
plt_oilsupply_rpoil <- ggplot(data = dat_irf_global_oil) +
  geom_hline(yintercept = 0.0) +
  geom_line(mapping = aes(x = horizon, y = response_shock_oilsupply_rpoil)) +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_oilsupply_rpoil_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_oilsupply_rpoil_hi), linetype = "dotted") +          
...
plt_aggdemand_rpoil <- ggplot(data = dat_irf_global_oil) +
  ...
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_aggdemand_rpoil_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_aggdemand_rpoil_hi), linetype = "dotted") +            
...
plt_rpoil_rpoil <- ggplot(data = dat_irf_global_oil) +
  ...
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_rpoil_rpoil_lo), linetype = "dotted") +
  geom_line(data = dat_irf_global_oil_cs, mapping = aes(x = horizon, y = response_shock_rpoil_rpoil_hi), linetype = "dotted") +              
