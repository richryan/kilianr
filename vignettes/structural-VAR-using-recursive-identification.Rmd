...
plt_oilsupply_oilsupply <- ggplot(data = dat_irf_global_oil) +
  ...
  geom_line(data = dat_CI, mapping = aes(x = horizon, y = response_shock_oilsupply_oilsupply_lo)) + 
  geom_line(data = dat_CI, mapping = aes(x = horizon, y = response_shock_oilsupply_oilsupply_hi)) +   
...
(plt_oilsupply_oilsupply | plt_aggdemand_oilsupply | plt_rpoil_oilsupply) / 
  (plt_oilsupply_aggdemand | plt_aggdemand_aggdemand | plt_rpoil_oilsupply) / 
